...
export class AboutPage {
  ...
  getSpecialties(){
    this.restProvider.getSpecialties(this.access_token)
        .then((data: any) => {
  ...
  getRegions(){
    this.restProvider.getRegions(this.access_token)
        .then((data: any) => {
          console.log(data);
          this.regions = data;
        }, err => {
  ...
  saveDoctor(): void {
    ...
    console.log(doctor);
    this.restProvider.saveDoctor(doctor, this.access_token).then((response) => {
